...
const VARS_DIR = path.resolve("templates/varsv3");
const TEMPLATE = path.resolve("templates/backgrounds-v3.md");
...
async function main() {
  ...
  console.log(`Generating ${files.length} v3 backgrounds to ${OUT_DIR}...`);
  for (const file of files) {
    console.log(`\n--- Generating (v3) for ${path.basename(file)} ---`);
