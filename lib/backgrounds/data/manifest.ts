import type { BackgroundCatalog } from '../types';

export const backgroundCatalog: BackgroundCatalog = 
{
  "families": [
    {
      "id": "v3-ambience",
      ...
      "integration": {
        "type": "template_vars",
        "templatePath": "templates/backgrounds-v3.md",
        "varsDir": "templates/varsv3"
      },
    ...
    },
    {
      ...
      "integration": {
        "type": "template_vars",
        "templatePath": "templates/backgrounds-v4.md",
        "varsDir": "templates/varsv4"
      },
  ...
  "items": [
    ...
    {
      "id": "overhead-dark-slate-holiday",
    ...
    {
      "id": "overhead-slate-minimal-sushi",
